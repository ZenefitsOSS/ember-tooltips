...
The tooltip can also be shown programatically by passing in the `isVisible` property, [documented here](#is-visible).
...
{{tooltip-on-component isVisible=showTooltip}}
```
